    ...
    <main className="flex min-h-screen flex-col items-center p-8 bg-gray-50/50">
      <div className="flex w-full max-w-4xl justify-between items-center mb-4">
        <div className="flex items-center gap-4">
          <Link href="/" className="text-gray-500 hover:text-blue-600 font-medium px-3 py-1.5 bg-white border rounded shadow-sm flex items-center gap-2 transition-colors">
            ← {lang === 'zh' ? '返回主页' : 'Back'}
          </Link>
